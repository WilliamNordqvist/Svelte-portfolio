const content = [
  ...
  },
  {
    ...
    github: null,
    description:
    "<p>The Insurely map was my final exams in school where I decided to build an insurance map for Insurley. The map purpose is to help consumers to compare their insurance expenses with others in same or similar areas. <br/> The map is built with React.</p>"
  },
  {
    name: "natten",
  ...
  },
  {
    ...
    github:null,
    description:
    "<p>My portfolio created in Svelte where I add all my work for job searching purpose.</p>"
  },
  {
    name: "Angular Todo-list",
    img: "assets/angular-list.png",
    link: "http://wnordqvist.com/angular-todo/",
    github:"https://github.com/WilliamNordqvist/angular-todo-list",
    description:
    "<p>Todo app created in Angular and Firebase.</p>"
  },
  {
    name: "MovieSearch",
  ...
  },
  {
    ...
    github: null,
    description:
    "<p>This was a Svelte course I took to improve my skills. You can read more about the course <a href={'https://www.udemy.com/course/sveltejs-the-complete-guide/'}> here</a>. </p>"
  },
  {
    name: "Portfolio 2.0",
  ...
  },
  {
    ...
    img: "assets/charactergenerator.png",
    link: "http://wnordqvist.com/character-generator/",
    github: "https://github.com/WilliamNordqvist/Character-Genererator-Local-Storage",
    description:
    "<p>Final project in vanilla js / HTML, where our task was to build a project and focus on map, filter and foreach before the React courses.</p>"
  },
  {
    name: "Texteditor",
    img: "assets/texteditor.png",
    link: "http://wnordqvist.com/texteditor/",
    github: "https://github.com/WilliamNordqvist/Quire-by-Capricorn",
    description:
    "<p> One of the first projects I got assigned in school, where our task was to create a text editor in vanilla js together with localstorage. </p>"
  },
  {
    name: "Portfolio 1.0",
    ...
    description:
    "<p> One of the first projects created in school where our task was to build a portfolio in vanilla js and HTML.</p>"
  }
];
